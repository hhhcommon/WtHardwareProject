package com.wotingfm.ui.mine.set.preference.main;
...
public class PreferenceFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.activity_preference, container, false);
    ...
    private void initView() {
        lv_prefer = (ListView) rootView.findViewById(R.id.lv_prefer);
        rootView.findViewById(R.id.tv_save).setOnClickListener(this);//保存
