...
public class PersonMoreFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.activity_person_more, container, false);
    ...
    private void handleIntent() {
        UserInviteMeInside groupNews = (UserInviteMeInside) getArguments().getSerializable("person");
        if (groupNews == null) {
            return;
        }
