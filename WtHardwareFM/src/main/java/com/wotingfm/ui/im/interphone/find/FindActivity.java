package com.wotingfm.ui.im.interphone.find;
...
import com.wotingfm.ui.im.interphone.find.result.FindNewsResultActivity;
...
//					voice_type = 2;
	...
	/*		mIatResults.clear(); 	// 设置参数 setParam(); // 开始听写
            ...
            case R.id.lin_contactsearch:
                ...
                bundle1.putString(StringConstant.FIND_TYPE, type);
