package com.wotingfm.ui.im.interphone.find.result;
...
import com.wotingfm.ui.im.interphone.find.result.adapter.FindFriendResultAdapter;
import com.wotingfm.ui.im.interphone.find.result.adapter.FindGroupResultAdapter;
                ...
                if (!type.trim().equals("")) {
                    if (type.equals(StringConstant.FIND_TYPE_PERSON)) {
                        if (position > 0) {
                            ...
                            // 是好友跳转至好友详情界面 -- > TalkPersonNewsActivity
                    ...
                    if (ReturnType != null && ReturnType.equals("1001")) {
                        try {
                            ...
                            if (UserList != null && UserList.size() > 0) {
                                if (RefreshType == 1) {
                                    adapter = new FindFriendResultAdapter(context, UserList);
                        ...
                        // 获取数据失败
                        ToastUtils.show_always(context, "没有搜索到相关用户!");
                    } else {
                        if (RefreshType == 1) {
                            mXListView.stopRefresh();
                        } else {
                ...
                try {
                    ...
                    if (ReturnType != null && ReturnType.equals("1001")) {
                        try {
                            ...
                            if (GroupList != null && GroupList.size() > 0) {
                                if (RefreshType == 1) {
                                    adapters = new FindGroupResultAdapter(context, GroupList);
