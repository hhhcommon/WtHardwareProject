package com.wotingfm.ui.music.comment.main;
...
public class CommentFragment extends Fragment implements View.OnClickListener {
    ...
    private void setView() {
        lin_back = (LinearLayout) rootView.findViewById(R.id.head_left_btn);
        lv_comment = (ListView) rootView.findViewById(R.id.lv_comment);
        lv_comment.setSelector(new ColorDrawable(Color.TRANSPARENT));// 取消默认selector
        image_face = (ImageView) rootView.findViewById(R.id.image_face);//表情图标
        chat_face_container = (LinearLayout) rootView.findViewById(R.id.chat_face_container);//表情布局
        mViewPager = (ViewPager) rootView.findViewById(R.id.face_viewpager);
        mViewPager.setOnPageChangeListener(new PageChange());
        mDotsLayout = (LinearLayout) rootView.findViewById(R.id.face_dots_container);//表情下小圆点
        input = (MyEditText) rootView.findViewById(R.id.input_sms);
        send = (TextView) rootView.findViewById(R.id.send_sms);
    }
