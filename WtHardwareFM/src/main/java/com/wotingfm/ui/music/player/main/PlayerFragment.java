package com.wotingfm.ui.music.player.main;
...
public class PlayerFragment extends Fragment implements View.OnClickListener,
    ...
    private void initEvent() {
        rootView.findViewById(R.id.tv_program).setOnClickListener(this);
                ...
                try {
                    ...
                    if (ReturnType.equals("1001")) {
                        ...
                        if (requestType.equals(StringConstant.PLAY_REQUEST_TYPE_MAIN_PAGE)) {
                            ...
                            list = new Gson().fromJson(listString, new TypeToken<List<LanguageSearchInside>>() {
                            }.getType());
