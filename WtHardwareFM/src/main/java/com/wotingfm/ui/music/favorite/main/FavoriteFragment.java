package com.wotingfm.ui.music.favorite.main;
...
//        textTts.setOnClickListener(new txListener(4));
        ...
        textEmpty = (TextView) rootView.findViewById(R.id.tv_qingkong);// 清空
        textEmpty.setOnClickListener(this);

        textEditor = (TextView) rootView.findViewById(R.id.tv_bianji);// 编辑
        ...
        if (currentIndex == 0) {
            ...
            if (type == 1) {// 打开 view
                ...
                if (flag) {
                    ...
                    context.sendBroadcast(new Intent(BroadcastConstants.SET_NOT_LOAD_REFRESH));
                    textFlag = 1;
                ...
                context.sendBroadcast(new Intent(BroadcastConstants.SET_LOAD_REFRESH));
            } else if (type == 3) {// 全选
