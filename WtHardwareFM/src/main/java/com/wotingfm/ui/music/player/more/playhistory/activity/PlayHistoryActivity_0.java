...
import com.wotingfm.ui.music.player.more.playhistory.fragment.RadioFragment;
import com.wotingfm.ui.music.player.more.playhistory.fragment.SoundFragment;
import com.wotingfm.ui.music.player.more.playhistory.fragment.TTSFragment;
import com.wotingfm.ui.music.player.more.playhistory.fragment.TotalFragment;
 ...
 * @author woting11
 */
public class PlayHistoryActivity_0 extends BaseFragmentActivity implements View.OnClickListener {
        ...
        switch (i) {
            case 2: // 声音
                if (!SoundFragment.isData) {
                    ...
                    openEdit.setText("取消");
                    PlayHistoryActivity_0.isEdit = false;
    ...
    private void setCancel(){
        ...
        PlayHistoryActivity_0.isEdit = true;
        openEdit.setText("编辑");
        dialogFlag = 0;
    }
