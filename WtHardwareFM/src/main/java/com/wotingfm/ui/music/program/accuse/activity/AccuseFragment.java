...
public class AccuseFragment extends Fragment implements OnClickListener {
    ...
    private void initView() {
        ...
        mListView = (ListView) rootView.findViewById(R.id.lv_main);                         // 主 listView
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.head_left_btn:// 返回
                ...
                switch (jumpType) {
                    case StringConstant.TAG_PLAY:// 播放
                        PlayerActivity.close();
                        break;
                    case StringConstant.TAG_PROGRAM:// 节目
                        ProgramActivity.close();
                        break;
                    case StringConstant.TAG_SEARCH:// 搜索
