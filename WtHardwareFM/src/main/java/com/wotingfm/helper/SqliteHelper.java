...
public class SqliteHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS playerhistory(_id Integer primary key autoincrement, "
				...
				+ "playeraddtime varchar(50),bjuserid varchar(50),playshareurl varchar(100),playfavorite varchar(100)," +
				"contentid varchar(50),localurl varchar(100),sequname varchar(50),sequimg varchar(200)," +
				"sequdesc varchar(150),sequid varchar(50))");
		...
		db.execSQL("create table IF NOT EXISTS fileinfo(_id integer primary key autoincrement,"
				...
				+ "sequname varchar(50),sequimgurl varchar(200),sequdesc varchar(150)," +
				"sequid varchar(50),userid varchar(50),downloadtype varchar(10),playshareurl varchar(100),"
				+ "playfavorite varchar(100),contentid varchar(50))");
