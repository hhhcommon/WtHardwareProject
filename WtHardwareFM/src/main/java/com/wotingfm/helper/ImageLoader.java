...
public class ImageLoader {
    ...
    private Map<ProgressBar, String> probars = Collections.synchronizedMap(new WeakHashMap<ProgressBar, String>());
    // 线程池
    ...
    class BitmapDisplayer implements Runnable {
        ...
        public void run() {
            ...
            if (bitmap != null) {
                ...
                //设置默认图片
//				bitmap = BitmapUtils.readBitMap(Context, R.drawable.wt_linkman_news);
//				photoToLoad.imageView.setImageBitmap(bitmap);
            }
        }
    }
