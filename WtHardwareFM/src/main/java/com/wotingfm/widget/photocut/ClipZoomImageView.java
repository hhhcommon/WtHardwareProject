...
//    private int mTouchSlop;
    ...
    private class AutoScaleRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (((tmpScale > 1f) && (currentScale < mTargetScale))
                    || ((tmpScale < 1f) && (mTargetScale < currentScale))) {    // 如果值在合法范围内，继续缩放
    ...
    public Bitmap clip() {
        ...
        return Bitmap.createBitmap(bitmap, mHorizontalPadding,
                mVerticalPadding, getWidth() - 2 * mHorizontalPadding, getWidth() - 2 * mHorizontalPadding);
    }
    ...
    private void checkBorder() {
        ...
        Log.e(TAG, "rect.width() =  " + rect.width()
                + " , width - 2 * mHorizontalPadding =" + (width - 2 * mHorizontalPadding));
