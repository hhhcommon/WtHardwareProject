package com.wotingfm.activity.mine.set.notifyset;
...
public class NotifySetActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initViews() {
        ...
        findViewById(R.id.view_notify_group_chat).setOnClickListener(this);// 群聊通知
        imageNotifyGroupChat = (ImageView) findViewById(R.id.image_notify_group_chat);// 群聊通知开关
        ...
        findViewById(R.id.view_notify_friend).setOnClickListener(this);// 好友通知
        imageNotifyFriend = (ImageView) findViewById(R.id.image_notify_friend);// 好友通知开关
        ...
        findViewById(R.id.view_notify_program).setOnClickListener(this);// 节目推送通知
        imageNotifyProgram = (ImageView) findViewById(R.id.image_notify_program);// 节目推送通知开关
        ...
        findViewById(R.id.view_notify_subscriber).setOnClickListener(this);// 订阅通知
        imageNotifySubscriber = (ImageView) findViewById(R.id.image_notify_subscriber);// 订阅通知开关
        ...
        findViewById(R.id.view_notify_concern).setOnClickListener(this);// 关注通知
        imageNotifyConcern = (ImageView) findViewById(R.id.image_notify_concern);// 关注通知开关
