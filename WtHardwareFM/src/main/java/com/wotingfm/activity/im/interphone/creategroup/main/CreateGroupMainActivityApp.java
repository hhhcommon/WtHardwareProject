...
import com.wotingfm.activity.im.interphone.creategroup.create.CreateGroupItemActivityApp;
 ...
 */
public class CreateGroupMainActivityApp extends AppBaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.relative_create_public:       // 创建公开群
                Intent intentPublic = new Intent(context, CreateGroupItemActivityApp.class);
            ...
            case R.id.relative_create_private:      // 创建密码群
                Intent intentPrivate = new Intent(context, CreateGroupItemActivityApp.class);
            ...
            case R.id.relative_create_verification: // 创建验证群
                Intent intentVerification = new Intent(context, CreateGroupItemActivityApp.class);
